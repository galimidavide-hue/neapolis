...
export default function FloatingCTA() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-rosso text-white px-4 py-3 rounded-full shadow-lg shadow-rosso/30 hover:bg-rosso/90 transition-colors animate-[pulse-slow]"
